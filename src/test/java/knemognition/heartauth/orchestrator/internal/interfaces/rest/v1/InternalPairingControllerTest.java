...
//import knemognition.heartauth.orchestrator.internal.app.impl.PairingStatusServiceImpl;
...
//
//    @Mock
//    private InternalPairingService createPairingService;
//
//    @InjectMocks
...
//        when(createPairingService.createPairing(req)).thenReturn(expected);
//
//        // when
...
//        assertThat(resp.getBody()).isSameAs(expected);
//
//        verify(createPairingService, times(1)).createPairing(req);

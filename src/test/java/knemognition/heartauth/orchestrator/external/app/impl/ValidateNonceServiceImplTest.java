...
//
//import static knemognition.heartauth.orchestrator.security.app.utils.KeyLoader.loadEcPublicKey;
...
//    @InjectMocks
//    ExternalValidationServiceImpl service;
//
//    @Test
...
//                .build();
//
//        assertDoesNotThrow(() -> service.validateNonce(req));
//    }
//
//    @Test
...
//                .build();
//
//        assertThrows(NonceValidationException.class, () -> service.validateNonce(req));
//    }
//
//}
package knemognition.heartauth.orchestrator.pairings.app.utils;
...
import knemognition.heartauth.orchestrator.security.config.jwt.JwtProperties;
...
public class QrDecoder {
    ...
    JwtDecoder pairingJwtDecoder(@Qualifier("pairingPublicKey") ECPublicKey pub, JwtProperties p, PairingProperties externalPairingProperties) {

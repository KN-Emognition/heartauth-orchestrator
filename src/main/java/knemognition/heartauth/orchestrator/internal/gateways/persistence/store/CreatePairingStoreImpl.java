...
import knemognition.heartauth.orchestrator.internal.gateways.persistence.mapper.CreatePairingMapper;
...
public class CreatePairingStoreImpl implements CreateFlowStore<CreatePairing> {
    ...
    private final CreatePairingMapper createPairingMapper;
    ...
    public CreatedFlowResult create(CreatePairing state) {
        ...
        var ent = createPairingMapper.fromCreate(state, id, ttl);
        pairingStateRepository.save(ent);
        return createPairingMapper.toCreatedResult(ent);
    }
}